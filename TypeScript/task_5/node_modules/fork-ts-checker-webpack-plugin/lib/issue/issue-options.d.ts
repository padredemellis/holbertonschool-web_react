import type { IssueMatch } from 'fork-ts-checker-webpack-plugin/lib/issue/issue-match';
import type { IssuePredicate } from 'fork-ts-checker-webpack-plugin/lib/issue/issue-predicate';
